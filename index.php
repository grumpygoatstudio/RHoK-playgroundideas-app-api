...
<html>
	...
	<body>
		...
		<ul>
			...
			<li><a href="images/get.php?userId=12&designId=1&assetName=RHoK - playground API - Melbourne Nov 16 (1).png" target="_blank">Get an Asset</a></li>
			<li><a href="images/playground_get_all.php?userId=12&designId=1" target="_blank">Get All Assets From A Playground</a></li>
		</ul>
		<hr />
